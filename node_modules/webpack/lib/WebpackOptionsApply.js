...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/badr/.vscode/extensions/wallabyjs.console-ninja-1.0.456/out/buildHook/index.js').default({tool: 'webpack', checkSum: '204f5adecb0319af038222AUgMWUpVWQZTBwdYAldWVlxWA1QC', mode: 'build'}); } catch(cjsError) { try { import('file:///home/badr/.vscode/extensions/wallabyjs.console-ninja-1.0.456/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '204f5adecb0319af038222AUgMWUpVWQZTBwdYAldWVlxWA1QC', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

...
import img1 from '../../assets/Nightpharm/Screenshot from 2025-07-09 14-04-31.png'
import img2 from '../../assets/Nightpharm/Screenshot from 2025-07-09 14-04-48.png'
import img3 from '../../assets/Nightpharm/Screenshot from 2025-07-09 14-05-15.png'
import img4 from '../../assets/Nightpharm/Screenshot from 2025-07-09 14-15-40.png'
import img5 from '../../assets/Nightpharm/Screenshot from 2025-07-09 14-17-42.png'
import img6 from '../../assets/Nightpharm/Screenshot from 2025-07-09 14-17-49.png'
  ...
  const features = [
    {
      ...
      description:
        "Uses geolocation and mapping technology to display real-time pharmacy locations and operating hours based on your location or GPS.",
      benefit: "Saves time and reduces stress during urgent situations, especially at night.",
    },
    {
      icon: Users,
      title: "Nurse Consultations",
      description:
        "Connect with nurses via messaging or video calls to get advice on symptoms, medications, or health concerns, anytime.",
      benefit: "Provides timely guidance when in-person visits aren't possible.",
    },
    {
      icon: Truck,
      title: "Delivery Management",
      description:
        "Users can order medications through the platform, while suppliers manage orders, track deliveries, and optimize routes.",
      benefit: "Ensures fast and reliable medicine delivery, crucial for emergencies or immobile users.",
    },
    {
      icon: Settings,
      title: "Administrative Oversight",
      description:
        "Administrators use a dashboard to oversee operations, manage user roles, set permissions, and track performance.",
      benefit: "Keeps the platform running smoothly and securely for all users.",
    },
  ]
          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            <div className="flex items-center gap-8">
              <button className="flex items-center gap-2 text-white hover:text-teal-400 transition-colors duration-300">
                ...
                <span className="font-medium">Back to Projects</span></a>
              </button>
            </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-16 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <p className="text-xl md:text-2xl text-gray-400 mb-8">Healthcare Accessibility Platform</p>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              >
                <div className="bg-black/20 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-500 rounded-lg p-6 md:p-8 mb-12">
                  <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">🌙 What is NightPharm?</h2>
                  <p className="text-gray-300 text-lg leading-relaxed mb-6">
                    NightPharm is a web-based platform designed to improve healthcare accessibility and streamline
                    pharmacy-related operations, especially during late-night hours or emergencies. It caters to a
                    variety of users—regular individuals, nurses, suppliers, and administrators—offering tailored tools
                    to meet their specific needs.
                  </p>
                  <p className="text-gray-400 leading-relaxed">
                    NightPharm addresses the challenge of finding pharmacies and healthcare support outside regular
                    hours. Whether you need medicine at 2 a.m. or professional advice in an emergency, this platform
                    ensures healthcare remains accessible and efficient, day or night.
                  </p>
                </div>
              </div>
            </div>
